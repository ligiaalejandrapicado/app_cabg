...
$sql = "SELECT c.cod_nta, b.des_csod,c.pts_nta,c.obs_nta, d.des_cso  FROM inscripcion a, curso_detalle b, notas c , curso d  where 
 a.ci_ste='$ci_sim' && a.cod_ico=c.cod_ico   && a.cod_cso=b.cod_cso && c.cod_csod=b.cod_csod && d.cod_cso=b.cod_cso
 ORDER BY a.cod_ico DESC  ";
...
if($band==1){
  ...
  <tr>
    ...
    <td width='70%' align='center' valign='middle' bgcolor='#FFFFFF'>CURSO, TALLER O MÓDULO </td>
    <td width='20%' align='center' valign='middle' bgcolor='#FFFFFF'>PTS</td>
  </tr>
</table>
...
";
  ...
  <tr>
    ...
    <td width='70%' align='center' valign='middle' bgcolor='#FFDFDF'><strong>$rege[4]:</strong> $rege[1]</td>
    <td width='20%' align='center' valign='middle' bgcolor='#FFDFDF'>$rege[2]</td>
  </tr>
</table>
